...
@section('content')
  ...
  <div class="green">
	...
	<div class="yellow">
  	<div class="container">
  	    <div class="row margin-bottom-lg">
            ...
            <h3 class="raver-text text-left visible-xs visible-sm ">Water for the EDM seed</h3>
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <img src="{{ asset('img/wedm.png') }}" alt="Water EDM" width="60%" class="center-block visible-xs visible-sm" >
          </div>
  	    </div>
  		</div>
  	</div>	
  	...
  	<div class="white">
      <div class="container">
        <h2 class="text-center margin-top">Average population</h2>
        <div class="row">
    ...
    <div class="blue">
      <div class="container">
        <div class="row">
            ...
            <h2 class="water text-left visible-md visible-lg">How much water we drink?</h2>
            <h3 class="water text-left visible-xs visible-sm ">How much water we drink?</h3>
	        ...
	        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 margin-bottom-xlg">
	          <img src="{{ asset('img/water.png') }}" alt="Water Planet" width="60%" class="center-block vertical_2 visible-md visible-lg" >
            <img src="{{ asset('img/water.png') }}" alt="Water Planet" width="60%" class="center-block visible-xs visible-sm" >
	        </div>
      	</div>
    	</div>
    </div>   
      ...
      <div class="container">
      	...
      	<div class="row margin-bottom-lg">
      		<div class="col-xs-1"><img src="{{ asset('img/bottle.png') }}" alt="Barril" width="30%" class="center-block visible-md visible-lg"></div>
    ...
    <div class="white">
    	<div class="container">
    		<div class="row">
    			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 margin-top-lg">
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <img src="{{ asset('img/carpa.png') }}" alt="Tents" width="60%" class="center-block vertical margin-bottom-lg visible-md visible-lg" >
            <img src="{{ asset('img/carpa.png') }}" alt="Tents" width="60%" class="center-block margin-bottom-lg visible-xs visible-sm" >
          </div>
    		</div>
				<div class="row">
