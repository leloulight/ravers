	...
	<div class="yellow">
  	<div class="container">
  	    <div class="row margin-bottom-lg">
  	        ...
  	        <img src="{{ asset('img/wedm.png') }}" alt="Water EDM" width="60%" class="center-block vertical_2" >
  	      </div>
