...
@section('content')
	<div class="white">
      <div class="container">
        <h2 class="text-pink visible-lg"><strong>DJ'S</strong> BIRTHDAYS <strong>CHALLENGE</strong></h2>
        <h3 class="text-pink visible-sm visible-md"><strong>DJ'S</strong> BIRTHDAYS <strong>CHALLENGE</strong></h3>
				<h3 class="text-pink visible-xs bg-imagen"><strong>DJ'S</strong> BIRTHDAYS <strong>CHALLENGE</strong></h3>
