            ...
            <div class="row">
                <div class="col-sm-12 margin-top-lg margin-bottom-xlg">
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        <p class="text-justify texto-blanco">Estamos trabajando para brindarte la mejor experiencia, te mantendremos informado de nuestro avanze.
                            <br/> Gracias por registrarte con nosotros..</p>
                        <br>
