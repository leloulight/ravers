...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7"><h5 class="texto-oscuro">International Ravers is a 501 (c)(3) pending • <a href="{{ route('policy')}}">privacy policy</a> • ©2015 • made with ❤ in CA. </h5></div>
