...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12"><p class="texto-oscuro">International Ravers is a 501 (c)(3) PENDING Non Profit Organization • <a href="{{ route('policy') }}">Privacy Policy</a> • <a href="{{ route('terms')}}">Terms of Use</a> • ©2015 • Made with ❤ in CA. </p></div>
            </div>
        </div>
    </div>
